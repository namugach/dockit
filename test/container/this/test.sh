...
# 4. 컨테이너 정지 (this 인자 사용)
log_step "4. 컨테이너 정지 (dockit stop this)"
run_command "dockit stop this"

# 5. 컨테이너 시작 (this 인자 사용)
log_step "5. 컨테이너 재시작 (dockit start this)"
run_command "dockit start this"

# 6. 컨테이너 정지 (재정지 테스트)
log_step "6. 컨테이너 재정지 (dockit stop this)"
run_command "dockit stop this"
