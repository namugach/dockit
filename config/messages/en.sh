...
MSG_HELP_START="  start    - Start containers (options: number, this, all)"
...
MSG_HELP_CONNECT="  connect  - Connect to container (options: number, \"this\")"
MSG_HELP_STATUS="  status   - Check container status"
MSG_HELP_MIGRATE="  migrate  - Upgrade to a newer version"
MSG_HELP_IMAGE="  image    - Manage Docker images (list, ls, remove, clean, prune)"
...
MSG_COMPLETION_START="Start containers (options: number, \"this\", \"all\")"
MSG_COMPLETION_BUILD="Build Docker image"
MSG_COMPLETION_UP="Start container in background"
MSG_COMPLETION_STOP="Stop containers (options: number, \"this\", \"all\")"
