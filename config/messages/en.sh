...
MSG_HELP_CLONE="  clone    - Clone an existing project (number, id, name)"
...
MSG_CLONE_MODULE_TITLE="Project Clone"
MSG_CLONE_STARTING="Cloning project #%s..."
MSG_CLONE_ERROR_NO_SOURCE="Source project is required."
MSG_CLONE_USAGE="Usage: dockit clone <source_project_id | number> [new_project_name]"
MSG_CLONE_ENTER_NAME="Enter new project name"
MSG_CLONE_DIRECTORY_EXISTS="Directory '%s' already exists."
MSG_CLONE_SUGGESTED_NAME="Suggested name: '%s'"
MSG_CLONE_DIRECTORY_CONFLICT="Directory '%s' already exists. Please try another name."
MSG_CLONE_GATHERING_INFO="Gathering source project information..."
MSG_CLONE_INFO_SUCCESS="Source project information gathered successfully."
MSG_CLONE_DETERMINING_NAME="Determining target project name..."
MSG_CLONE_TARGET_NAME="Target project name set to: %s"
MSG_CLONE_STARTING_EXECUTION="Starting clone process..."
MSG_CLONE_EXECUTION_SUCCESS="Clone process completed successfully."
MSG_CLONE_COMPLETED="Project cloned successfully!"
MSG_CLONE_NEXT_STEPS="Next steps:"
MSG_CLONE_ERROR_INFO_FAILED="Failed to gather source project information."
MSG_CLONE_ERROR_EXECUTION_FAILED="Clone process failed."
MSG_CLONE_WARN_ROLLBACK_DISABLED="Warning: Rollback is disabled."
MSG_CLONE_ERROR_CLONE_FAILED_ROLLBACK="[ERROR] Clone failed! Starting rollback..."
MSG_CLONE_ROLLBACK_REMOVE_REGISTRY="[ROLLBACK] Removing registry entry: %s"
MSG_CLONE_ROLLBACK_REMOVE_REGISTRY_SUCCESS="[ROLLBACK] Registry entry removed successfully."
MSG_CLONE_ROLLBACK_REMOVE_REGISTRY_FAILED="[ROLLBACK] Failed to remove registry entry."
MSG_CLONE_ROLLBACK_NO_JQ="[ROLLBACK] jq command not found or registry file does not exist."
MSG_CLONE_ROLLBACK_REMOVE_DIR="[ROLLBACK] Removing created directory: %s"
MSG_CLONE_ROLLBACK_REMOVE_DIR_SUCCESS="[ROLLBACK] Directory removed successfully."
MSG_CLONE_ROLLBACK_REMOVE_DIR_FAILED="[ROLLBACK] Failed to remove directory."
MSG_CLONE_ROLLBACK_REMOVE_IMAGE="[ROLLBACK] Removing created Docker image: %s"
MSG_CLONE_ROLLBACK_REMOVE_IMAGE_SUCCESS="[ROLLBACK] Docker image removed successfully."
MSG_CLONE_ROLLBACK_REMOVE_IMAGE_FAILED="[ROLLBACK] Failed to remove Docker image (already removed or does not exist)."
MSG_CLONE_ROLLBACK_SUCCESS="[ROLLBACK] Rollback completed successfully."
MSG_CLONE_ROLLBACK_ERROR="[ROLLBACK] %d errors occurred during rollback."
MSG_CLONE_WARN_UNEXPECTED_EXIT="[WARN] Unexpected exit detected. Executing rollback..."
MSG_CLONE_WARN_HYPHEN_IN_NAME="⚠️  Directory name contains a hyphen (-)."
MSG_CLONE_INFO_HYPHEN_RECOMMENDATION="💡 For Docker compatibility, we recommend converting it to an underscore (_): %s → %s"
MSG_CLONE_ERROR_INVALID_PROJECT_NAME="❌ Invalid project name: '%s'"
MSG_CLONE_INFO_ALLOWED_CHARS="📋 Allowed characters: letters, numbers, underscore (_)."
MSG_CLONE_INFO_HYPHEN_NOT_ALLOWED="📋 Hyphen (-) is not allowed to prevent Docker path conversion issues."
MSG_CLONE_INFO_NAME_LENGTH="📋 Length: 1-50 characters, no special characters/spaces/path characters."
MSG_CLONE_ERROR_PROJECT_NOT_FOUND="[ERROR] Project #%s not found."
MSG_CLONE_ERROR_READ_PROJECT_INFO="[ERROR] Could not read project information."
MSG_CLONE_DEBUG_PATH="[DEBUG] Path: %s"
MSG_CLONE_DEBUG_IMAGE="[DEBUG] Image: %s"
MSG_CLONE_DEBUG_CONTAINER="[DEBUG] Container: %s"
MSG_CLONE_DEBUG_STATE="[DEBUG] State: %s"
MSG_CLONE_ERROR_INVALID_PROJECT_NAME_PROVIDED="[ERROR] Invalid project name provided: '%s'"
MSG_CLONE_INFO_ALLOWED_CHARS_WITH_HYPHEN="[INFO] Allowed characters: letters, numbers, hyphen (-), underscore (_)."
MSG_CLONE_INFO_NAME_LENGTH_SIMPLE="[INFO] Length: 1-50 characters, no special characters/spaces/path characters."
MSG_CLONE_INFO_CHECKING_CONTAINER_STATUS="[INFO] Checking container status: %s"
MSG_CLONE_WARN_CONTAINER_STOPPED="[WARN] Container is stopped. Starting automatically..."
MSG_CLONE_SUCCESS_CONTAINER_STARTED="[SUCCESS] Container started successfully."
MSG_CLONE_SUCCESS_CONTAINER_START_COMPLETE="[SUCCESS] Container start complete."
MSG_CLONE_ERROR_CONTAINER_START_TIMEOUT="[ERROR] Container start timed out (%s seconds)."
MSG_CLONE_ERROR_CONTAINER_START_FAILED="[ERROR] Failed to start container: %s"
MSG_CLONE_SUCCESS_CONTAINER_RUNNING="[SUCCESS] Container is already running."
MSG_CLONE_INFO_PREPARING_CONTAINER="[INFO] Checking and preparing container..."
MSG_CLONE_ERROR_CANNOT_START_CONTAINER="[ERROR] Cannot start container."
MSG_CLONE_INFO_COMMITTING_IMAGE="[INFO] Committing Docker image..."
MSG_CLONE_INFO_CREATING_NEW_IMAGE="[INFO] Creating new image: %s"
MSG_CLONE_ERROR_COMMIT_FAILED="[ERROR] Docker commit failed."
MSG_CLONE_SUCCESS_COMMIT_COMPLETE="[SUCCESS] Image commit complete."
MSG_CLONE_INFO_CREATING_PROJECT_STRUCTURE="[INFO] Creating project structure..."
MSG_CLONE_ERROR_CREATE_DIR_FAILED="[ERROR] Failed to create project directory."
MSG_CLONE_ERROR_COPY_CONFIG_FAILED="[ERROR] Failed to copy configuration files."
MSG_CLONE_SUCCESS_PROJECT_STRUCTURE_CREATED="[SUCCESS] Project structure created."
MSG_CLONE_INFO_UPDATING_CONFIG="[INFO] Updating configuration files..."
MSG_CLONE_ERROR_INVALID_CONTAINER_NAME="[ERROR] Generated container name is not valid for Docker: %s"
MSG_CLONE_SUCCESS_COMPOSE_UPDATED="[SUCCESS] docker-compose.yml updated."
MSG_CLONE_SUCCESS_CONFIG_UPDATED="[SUCCESS] Configuration files updated."
MSG_CLONE_INFO_REGISTERING="[INFO] Registering project..."
MSG_CLONE_ERROR_ID_GENERATION_FAILED="[ERROR] Failed to generate project ID."
MSG_CLONE_WARN_NO_ENV_FILE="[WARN] .env file not found, using default values."
MSG_CLONE_ERROR_REGISTRATION_FAILED="[ERROR] Failed to register project."
MSG_CLONE_SUCCESS_REGISTRATION_COMPLETE="[SUCCESS] Project registered."
MSG_CLONE_PROGRESS_STEP_1="Checking and starting container"
MSG_CLONE_PROGRESS_STEP_2="Committing Docker image"
MSG_CLONE_PROGRESS_STEP_3="Creating project structure"
MSG_CLONE_PROGRESS_STEP_4="Copying and updating configuration"
MSG_CLONE_PROGRESS_STEP_5="Registering project"
...
MSG_CLEANUP_MODULE_CONTAINERS="  containers    Clean broken containers"
MSG_CLEANUP_MODULE_IMAGES="  images        Clean unused images"
MSG_CLEANUP_MODULE_NETWORKS="  networks      Clean unused networks"
MSG_CLEANUP_MODULE_ALL="  all           Clean all broken resources"
...
MSG_CLEANUP_DETECTING_CONTAINERS="Detecting broken containers..."
...
MSG_CLEANUP_NO_BROKEN_CONTAINERS="No broken containers found."
MSG_CLEANUP_NO_BROKEN_IMAGES="No unused images found."
MSG_CLEANUP_NO_BROKEN_NETWORKS="No unused networks found."

MSG_CLEANUP_FOUND_BROKEN_CONTAINERS="Found %d broken containers:"
MSG_CLEANUP_FOUND_BROKEN_IMAGES="Found %d unused images:"
MSG_CLEANUP_FOUND_BROKEN_NETWORKS="Found %d unused networks:"
...
MSG_CLEANUP_CONFIRM_ALL="Remove all broken resources? [Y/n]: "
...
MSG_CLEANUP_ALL_START="Starting cleanup of all broken resources."
MSG_CLEANUP_ALL_SUMMARY="📋 Resources to clean:"
MSG_CLEANUP_SUMMARY_CONTAINERS="Broken containers: %d"
MSG_CLEANUP_SUMMARY_IMAGES="Unused images: %d"
MSG_CLEANUP_SUMMARY_NETWORKS="Unused networks: %d"

MSG_CLEANUP_ALL_NO_BROKENS="No broken resources to clean."
MSG_CLEANUP_ALL_EXECUTING="Starting cleanup..."
MSG_CLEANUP_ALL_STEP_CONTAINERS="🗂️  Cleaning broken containers..."
MSG_CLEANUP_ALL_STEP_IMAGES="🗂️  Cleaning unused images..."
MSG_CLEANUP_ALL_STEP_NETWORKS="🗂️  Cleaning unused networks..."
MSG_CLEANUP_ALL_STEP_ADDITIONAL_NETWORKS="🗂️  Cleaning additional broken networks..."
...
MSG_CLEANUP_STATUS_BROKEN_CONTAINERS="Found %d broken containers"
MSG_CLEANUP_STATUS_BROKEN_IMAGES="Found %d unused images"
MSG_CLEANUP_STATUS_BROKEN_NETWORKS="Found %d unused networks"
MSG_CLEANUP_STATUS_NO_BROKENS="All resources are in normal state."
MSG_CLEANUP_STATUS_CLEANUP_HINT="To clean up:"

# Cleanup error messages
MSG_CLEANUP_MAIN_UNKNOWN_COMMAND="Unknown command: %s"
MSG_HELP_CLEANUP="  cleanup  - Clean up broken resources (containers, images, networks, all)"

# cleanup completion messages
MSG_COMPLETION_CLEANUP="Clean up broken resources"
MSG_CLEANUP_COMPLETION_CONTAINERS="Clean up broken containers"
MSG_CLEANUP_COMPLETION_IMAGES="Clean up unused images"
MSG_CLEANUP_COMPLETION_NETWORKS="Clean up unused networks"
MSG_CLEANUP_COMPLETION_ALL="Clean up all broken resources"
...
# Cleanup 완료 메시지
MSG_CLEANUP_REMOVING_COMPLETED="Cleanup completed"
