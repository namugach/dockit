...
MSG_INSTALL_START="Running installation module..."
MSG_INSTALL_COMPLETE="Installation completed!"
MSG_INSTALL_FAILED="An error occurred during installation."
MSG_INSTALL_CHECK_DOCKER="1. Check if Docker service is running"
MSG_INSTALL_CHECK_PORTS="2. Check if ports are available"
MSG_INSTALL_CHECK_IMAGE="3. Check if image exists (initialize if not)"

# install log messages
MSG_INSTALL_CHECK_DEPS="Checking dependencies..."
MSG_INSTALL_DOCKER_NOT_FOUND="Docker is not installed. Please install Docker first."
MSG_INSTALL_COMPOSE_NOT_FOUND="Docker Compose is not installed. Please install Docker Compose first."
MSG_INSTALL_TOOL_NOT_FOUND="%s is not installed. Please install %s first."
MSG_INSTALL_DEPS_SATISFIED="All dependencies are satisfied."
MSG_INSTALL_CHECK_EXISTING="Checking existing installation..."
MSG_INSTALL_ALREADY_INSTALLED="dockit is already installed."
MSG_INSTALL_REINSTALL_PROMPT="Do you want to reinstall? [y/N]: "
MSG_INSTALL_CANCELLED="Installation cancelled."
MSG_INSTALL_DIR_EXISTS="Project directory already exists: %s"
MSG_INSTALL_OVERWRITE_PROMPT="Do you want to overwrite? [y/N]: "
MSG_INSTALL_NO_PERMISSION="No write permission for: %s"
MSG_INSTALL_TRY_SUDO="Try running with sudo or check directory permissions."
MSG_INSTALL_ROOT_WARNING="Running as root. This is not recommended."
MSG_INSTALL_CONTINUE_PROMPT="Do you want to continue? [y/N]: "
MSG_INSTALL_CREATE_DIRS="Creating installation directories..."
MSG_INSTALL_PROJECT_FILES="Installing project files..."
MSG_INSTALL_COMPLETION_SCRIPTS="Installing completion scripts..."
MSG_INSTALL_ADD_PATH="Adding to PATH..."
MSG_INSTALL_SUCCESS="Installation successful!"
MSG_INSTALL_USE_COMMAND="You can now use 'dockit' command."
MSG_INSTALL_TRY_HELP="Try: dockit --help"
MSG_INSTALL_FAILED="Installation failed!"
MSG_INSTALL_STARTING="Starting dockit installation..."
MSG_INSTALL_RESTART_SHELL="Please restart your shell or run: source ~/.bashrc (or ~/.zshrc)" 