...
MSG_CLONE_ENTER_NAME="Enter project name"
MSG_CLONE_DIRECTORY_EXISTS="Directory '%s' already exists"
MSG_CLONE_SUGGESTED_NAME="Suggested name: '%s'"
MSG_CLONE_DIRECTORY_CONFLICT="Directory '%s' already exists. Try another name."
MSG_CLONE_GATHERING_INFO="Gathering source project information..."
MSG_CLONE_INFO_SUCCESS="Source project information collected"
MSG_CLONE_DETERMINING_NAME="Determining target project name..."
MSG_CLONE_TARGET_NAME="Target project name: %s"
MSG_CLONE_STARTING_EXECUTION="Starting clone execution..."
MSG_CLONE_EXECUTION_SUCCESS="Clone execution completed"
MSG_CLONE_COMPLETED="Clone completed successfully!"
MSG_CLONE_NEXT_STEPS="Next steps:"
MSG_CLONE_ERROR_INFO_FAILED="Failed to gather source project information"
MSG_CLONE_ERROR_EXECUTION_FAILED="Clone execution failed"
