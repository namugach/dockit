...
MSG_HELP_IMAGE="  image    - Manage Docker images (list, remove, clean, prune)"
...
MSG_IMAGE_MODULE_LIST="list                - List all dockit images"
MSG_IMAGE_MODULE_REMOVE="remove <image>      - Remove specific image by name or number"
MSG_IMAGE_MODULE_PRUNE="prune               - Remove unused dockit images (not used by containers)"
