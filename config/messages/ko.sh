...
MSG_SETUP_TERMINATED="setup 프로세스를 종료합니다."
...
# join 모듈 메시지
MSG_JOIN_START="자동 실행 및 접속 프로세스를 시작합니다..."
MSG_JOIN_COMPLETE="자동 실행 및 접속 프로세스가 완료되었습니다."
MSG_JOIN_RUN_START="자동 실행 모듈을 시작합니다..."
MSG_JOIN_RUN_COMPLETE="자동 실행 모듈이 완료되었습니다."
MSG_JOIN_CONNECT_START="자동 접속 모듈을 시작합니다..."
MSG_JOIN_CONNECT_COMPLETE="자동 접속 모듈이 완료되었습니다."
MSG_JOIN_HELP="  join     - 자동 실행(run) 및 접속(connect)을 한번에 실행"
