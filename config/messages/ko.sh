...
MSG_HELP_CLONE="  clone    - 기존 프로젝트 복제 (number, id, name)"
...
# Clone 모듈 메시지
MSG_CLONE_MODULE_TITLE="프로젝트 복제"
MSG_CLONE_STARTING="프로젝트 #%s 복제를 시작합니다..."
MSG_CLONE_ERROR_NO_SOURCE="소스 프로젝트를 지정해야 합니다."
MSG_CLONE_USAGE="사용법: dockit clone <소스_프로젝트_ID | 번호> [새_프로젝트_이름]"
MSG_CLONE_ENTER_NAME="새 프로젝트 이름을 입력하세요"
MSG_CLONE_DIRECTORY_EXISTS="디렉토리 '%s'가 이미 존재합니다."
MSG_CLONE_SUGGESTED_NAME="추천 이름: '%s'"
MSG_CLONE_DIRECTORY_CONFLICT="디렉토리 '%s'가 이미 존재합니다. 다른 이름을 사용해주세요."
MSG_CLONE_GATHERING_INFO="소스 프로젝트 정보를 수집 중입니다..."
MSG_CLONE_INFO_SUCCESS="소스 프로젝트 정보 수집을 완료했습니다."
MSG_CLONE_DETERMINING_NAME="대상 프로젝트 이름을 결정 중입니다..."
MSG_CLONE_TARGET_NAME="대상 프로젝트 이름이 '%s'(으)로 설정되었습니다."
MSG_CLONE_STARTING_EXECUTION="복제 프로세스를 시작합니다..."
MSG_CLONE_EXECUTION_SUCCESS="복제 프로세스가 성공적으로 완료되었습니다."
MSG_CLONE_COMPLETED="프로젝트 복제가 완료되었습니다!"
MSG_CLONE_NEXT_STEPS="다음 단계:"
MSG_CLONE_ERROR_INFO_FAILED="소스 프로젝트 정보 수집에 실패했습니다."
MSG_CLONE_ERROR_EXECUTION_FAILED="복제 프로세스에 실패했습니다."
MSG_CLONE_WARN_ROLLBACK_DISABLED="[경고] 롤백 기능이 비활성화되어 있습니다."
MSG_CLONE_ERROR_CLONE_FAILED_ROLLBACK="[오류] 복제에 실패하여 롤백을 시작합니다..."
MSG_CLONE_ROLLBACK_REMOVE_REGISTRY="[롤백] 레지스트리 항목을 제거합니다: %s"
MSG_CLONE_ROLLBACK_REMOVE_REGISTRY_SUCCESS="[롤백] 레지스트리 항목을 성공적으로 제거했습니다."
MSG_CLONE_ROLLBACK_REMOVE_REGISTRY_FAILED="[롤백] 레지스트리 항목 제거에 실패했습니다."
MSG_CLONE_ROLLBACK_NO_JQ="[롤백] jq 명령어를 찾을 수 없거나 레지스트리 파일이 없습니다."
MSG_CLONE_ROLLBACK_REMOVE_DIR="[롤백] 생성된 디렉토리를 제거합니다: %s"
MSG_CLONE_ROLLBACK_REMOVE_DIR_SUCCESS="[롤백] 디렉토리를 성공적으로 제거했습니다."
MSG_CLONE_ROLLBACK_REMOVE_DIR_FAILED="[롤백] 디렉토리 제거에 실패했습니다."
MSG_CLONE_ROLLBACK_REMOVE_IMAGE="[롤백] 생성된 Docker 이미지를 제거합니다: %s"
MSG_CLONE_ROLLBACK_REMOVE_IMAGE_SUCCESS="[롤백] Docker 이미지를 성공적으로 제거했습니다."
MSG_CLONE_ROLLBACK_REMOVE_IMAGE_FAILED="[롤백] Docker 이미지 제거에 실패했습니다 (이미 제거되었거나 존재하지 않음)."
MSG_CLONE_ROLLBACK_SUCCESS="[롤백] 롤백이 성공적으로 완료되었습니다."
MSG_CLONE_ROLLBACK_ERROR="[롤백] 롤백 중 %d개의 오류가 발생했습니다."
MSG_CLONE_WARN_UNEXPECTED_EXIT="[경고] 예기치 않은 종료가 감지되었습니다. 롤백을 실행합니다..."
MSG_CLONE_WARN_HYPHEN_IN_NAME="⚠️  디렉토리 이름에 하이픈(-)이 포함되어 있습니다."
MSG_CLONE_INFO_HYPHEN_RECOMMENDATION="💡 Docker 호환성을 위해 언더스코어(_)로 변환하는 것을 권장합니다: %s → %s"
MSG_CLONE_ERROR_INVALID_PROJECT_NAME="❌ 잘못된 프로젝트 이름입니다: '%s'"
MSG_CLONE_INFO_ALLOWED_CHARS="📋 허용 문자: 영문, 숫자, 언더스코어(_)."
MSG_CLONE_INFO_HYPHEN_NOT_ALLOWED="📋 하이픈(-)은 Docker 경로 변환 문제로 인해 사용할 수 없습니다."
MSG_CLONE_INFO_NAME_LENGTH="📋 길이: 1-50자, 특수문자/공백/경로 문자 사용 불가."
MSG_CLONE_INFO_CHECKING_CONTAINER_STATUS="[정보] 컨테이너 상태를 확인 중입니다: %s"
MSG_CLONE_WARN_CONTAINER_STOPPED="[경고] 컨테이너가 중지되어 있습니다. 자동으로 시작합니다..."
MSG_CLONE_SUCCESS_CONTAINER_STARTED="[성공] 컨테이너가 성공적으로 시작되었습니다."
MSG_CLONE_SUCCESS_CONTAINER_START_COMPLETE="[성공] 컨테이너 시작이 완료되었습니다."
MSG_CLONE_ERROR_CONTAINER_START_TIMEOUT="[오류] 컨테이너 시작 시간 초과 (%s초)."
MSG_CLONE_ERROR_CONTAINER_START_FAILED="[오류] 컨테이너 시작에 실패했습니다: %s"
MSG_CLONE_SUCCESS_CONTAINER_RUNNING="[성공] 컨테이너가 이미 실행 중입니다."
MSG_CLONE_INFO_PREPARING_CONTAINER="[정보] 컨테이너를 확인하고 준비 중입니다..."
MSG_CLONE_ERROR_CANNOT_START_CONTAINER="[오류] 컨테이너를 시작할 수 없습니다."
MSG_CLONE_INFO_COMMITTING_IMAGE="[정보] Docker 이미지를 커밋하는 중입니다..."
MSG_CLONE_INFO_CREATING_NEW_IMAGE="[정보] 새 이미지를 생성 중입니다: %s"
MSG_CLONE_ERROR_COMMIT_FAILED="[오류] Docker commit에 실패했습니다."
MSG_CLONE_SUCCESS_COMMIT_COMPLETE="[성공] 이미지 커밋이 완료되었습니다."
MSG_CLONE_INFO_CREATING_PROJECT_STRUCTURE="[정보] 프로젝트 구조를 생성 중입니다..."
MSG_CLONE_ERROR_CREATE_DIR_FAILED="[오류] 프로젝트 디렉토리 생성에 실패했습니다."
MSG_CLONE_ERROR_COPY_CONFIG_FAILED="[오류] 설정 파일 복사에 실패했습니다."
MSG_CLONE_SUCCESS_PROJECT_STRUCTURE_CREATED="[성공] 프로젝트 구조가 생성되었습니다."
MSG_CLONE_INFO_UPDATING_CONFIG="[정보] 설정 파일을 업데이트하는 중입니다..."
MSG_CLONE_ERROR_INVALID_CONTAINER_NAME="[오류] 생성된 컨테이너 이름이 Docker 규칙에 맞지 않습니다: %s"
MSG_CLONE_SUCCESS_COMPOSE_UPDATED="[성공] docker-compose.yml 파일이 업데이트되었습니다."
MSG_CLONE_SUCCESS_CONFIG_UPDATED="[성공] 설정 파일이 업데이트되었습니다."
MSG_CLONE_INFO_REGISTERING="[정보] 프로젝트를 등록하는 중입니다..."
MSG_CLONE_ERROR_ID_GENERATION_FAILED="[오류] 프로젝트 ID 생성에 실패했습니다."
MSG_CLONE_WARN_NO_ENV_FILE="[경고] .env 파일을 찾을 수 없어 기본값을 사용합니다."
MSG_CLONE_ERROR_REGISTRATION_FAILED="[오류] 프로젝트 등록에 실패했습니다."
MSG_CLONE_PROGRESS_STEP_1="컨테이너 상태 확인 및 시작"
MSG_CLONE_PROGRESS_STEP_2="Docker 이미지 커밋"
MSG_CLONE_PROGRESS_STEP_3="프로젝트 구조 생성"
MSG_CLONE_PROGRESS_STEP_4="설정 파일 복사 및 수정"
MSG_CLONE_PROGRESS_STEP_5="레지스트리에 등록"
MSG_CLONE_ERROR_CANNOT_DETERMINE_NAME="[오류] 유효한 프로젝트 이름을 결정할 수 없습니다."
...
MSG_CLEANUP_HEADER_CONTAINER="컨테이너"
MSG_CLEANUP_HEADER_IMAGE="이미지"
MSG_CLEANUP_HEADER_STATUS="상태"
MSG_CLEANUP_HEADER_ID="ID"
MSG_CLEANUP_HEADER_CREATED="생성일"
MSG_CLEANUP_HEADER_SIZE="크기"
...
MSG_CLEANUP_REMOVING_IMAGE="이미지 제거 중: %s... "
MSG_CLEANUP_REMOVING_NETWORK="네트워크 제거 중: %s... "

# Cleanup 완료 메시지
MSG_CLEANUP_REMOVED_CONTAINERS="%d개의 컨테이너가 제거되었습니다."
MSG_CLEANUP_REMOVED_IMAGES="%d개의 이미지가 제거되었습니다."
MSG_CLEANUP_REMOVED_NETWORKS="%d개의 네트워크가 제거되었습니다."

MSG_CLEANUP_FAILED_CONTAINERS="%d개의 컨테이너 제거에 실패했습니다."
MSG_CLEANUP_FAILED_IMAGES="%d개의 이미지 제거에 실패했습니다."
MSG_CLEANUP_FAILED_NETWORKS="%d개의 네트워크 제거에 실패했습니다."
