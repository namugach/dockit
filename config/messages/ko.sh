...
MSG_INVALID_CHOICE="잘못된 선택입니다. 설치가 취소되었습니다."

# install 모듈 메시지
MSG_INSTALL_START="설치 시작..."
...
MSG_BASE_IMAGE_NOT_SET="BASE_IMAGE가 설정되지 않았습니다. 기본 이미지를 사용합니다."
MSG_USING_BASE_IMAGE="사용할 베이스 이미지:"
...
MSG_CHECK_IMAGE="3. 이미지가 존재하는지 확인하세요 (없다면 설치 필요)"
