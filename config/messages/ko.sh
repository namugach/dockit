...
MSG_CLONE_ENTER_NAME="프로젝트 이름을 입력하세요"
MSG_CLONE_DIRECTORY_EXISTS="디렉토리 '%s'이(가) 이미 존재합니다"
MSG_CLONE_SUGGESTED_NAME="제안된 이름: '%s'"
MSG_CLONE_DIRECTORY_CONFLICT="디렉토리 '%s'이(가) 이미 존재합니다. 다른 이름을 시도해보세요."
MSG_CLONE_GATHERING_INFO="소스 프로젝트 정보를 수집하는 중..."
MSG_CLONE_INFO_SUCCESS="소스 프로젝트 정보가 수집되었습니다"
MSG_CLONE_DETERMINING_NAME="대상 프로젝트 이름을 결정하는 중..."
MSG_CLONE_TARGET_NAME="대상 프로젝트 이름: %s"
MSG_CLONE_STARTING_EXECUTION="복제 실행을 시작하는 중..."
MSG_CLONE_EXECUTION_SUCCESS="복제 실행이 완료되었습니다"
MSG_CLONE_COMPLETED="복제가 성공적으로 완료되었습니다!"
MSG_CLONE_NEXT_STEPS="다음 단계:"
MSG_CLONE_ERROR_INFO_FAILED="소스 프로젝트 정보 수집에 실패했습니다"
MSG_CLONE_ERROR_EXECUTION_FAILED="복제 실행에 실패했습니다"